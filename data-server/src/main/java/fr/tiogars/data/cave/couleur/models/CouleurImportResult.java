...
public class CouleurImportResult {

    @Schema(description = "Liste des couleurs ajoutes pendant cet import.")
    private List<Couleur> imported;

    @Schema(description = "Nombre de couleurs ajoutes (champ historique).", example = "12")
    private int importedCount;

    @Schema(description = "Liste des noms detectes en doublon (champ historique).")
    private List<String> duplicateNames;

    @Schema(description = "Nombre de couleurs non ajoutes (champ historique).", example = "3")
    private int skippedCount;

    @Schema(description = "Nombre de couleurs ajoutes.", example = "12")
    private int addedCount;

    @Schema(description = "Nombre total de couleurs non ajoutes.", example = "3")
    private int notAddedCount;

    @Schema(description = "Nombre de couleurs non ajoutes car deja presents.", example = "2")
    ...
    public CouleurImportResult(List<Couleur> imported, int addedCount, int notAddedCount, int alreadyExistsCount, int invalidCount, List<String> duplicateNames) {
    ...
    public List<Couleur> getImported() {
        return imported;
    }

    public void setImported(List<Couleur> imported) {
        this.imported = imported;
    }
