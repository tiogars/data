...
public class TypeVinSearchResponse extends GenericListResponse<TypeVin> {
    private int page;
    private int size;
    private String query;
    public TypeVinSearchResponse(List<TypeVin> items, int count, int page, int size, String query) {
