...
public class TypeVinImportResult {

    @Schema(description = "Liste des types de vin ajoutes pendant cet import.")
    private List<TypeVin> imported;

    @Schema(description = "Nombre de types de vin ajoutes (champ historique).", example = "12")
    private int importedCount;

    @Schema(description = "Liste des noms detectes en doublon (champ historique).")
    private List<String> duplicateNames;

    @Schema(description = "Nombre de types de vin non ajoutes (champ historique).", example = "3")
    private int skippedCount;

    @Schema(description = "Nombre de types de vin ajoutes.", example = "12")
    private int addedCount;

    @Schema(description = "Nombre total de types de vin non ajoutes.", example = "3")
    private int notAddedCount;

    @Schema(description = "Nombre de types de vin non ajoutes car deja presents.", example = "2")
    ...
    public TypeVinImportResult(List<TypeVin> imported, int addedCount, int notAddedCount, int alreadyExistsCount, int invalidCount, List<String> duplicateNames) {
    ...
    public List<TypeVin> getImported() {
        return imported;
    }

    public void setImported(List<TypeVin> imported) {
        this.imported = imported;
    }
