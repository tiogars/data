...
public class CirconstanceImportResult {

    @Schema(description = "Liste des circonstances ajoutes pendant cet import.")
    private List<Circonstance> imported;

    @Schema(description = "Nombre de circonstances ajoutes (champ historique).", example = "12")
    private int importedCount;

    @Schema(description = "Liste des noms detectes en doublon (champ historique).")
    private List<String> duplicateNames;

    @Schema(description = "Nombre de circonstances non ajoutes (champ historique).", example = "3")
    private int skippedCount;

    @Schema(description = "Nombre de circonstances ajoutes.", example = "12")
    private int addedCount;

    @Schema(description = "Nombre total de circonstances non ajoutes.", example = "3")
    private int notAddedCount;

    @Schema(description = "Nombre de circonstances non ajoutes car deja presents.", example = "2")
    ...
    public CirconstanceImportResult(List<Circonstance> imported, int addedCount, int notAddedCount, int alreadyExistsCount, int invalidCount, List<String> duplicateNames) {
    ...
    public List<Circonstance> getImported() {
        return imported;
    }

    public void setImported(List<Circonstance> imported) {
        this.imported = imported;
    }
