...
public class CouleurSearchResponse extends GenericListResponse<Couleur> {
    private int page;
    private int size;
    private String query;
    public CouleurSearchResponse(List<Couleur> items, int count, int page, int size, String query) {
