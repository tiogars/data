...
public class VinTagSearchResponse extends GenericListResponse<VinTag> {
    private int page;
    private int size;
    private String query;
    public VinTagSearchResponse(List<VinTag> items, int count, int page, int size, String query) {
