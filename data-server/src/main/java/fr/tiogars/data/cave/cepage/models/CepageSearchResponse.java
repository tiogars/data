...
public class CepageSearchResponse extends GenericListResponse<Cepage> {
    private int page;
    private int size;
    private String query;
    public CepageSearchResponse(List<Cepage> items, int count, int page, int size, String query) {
