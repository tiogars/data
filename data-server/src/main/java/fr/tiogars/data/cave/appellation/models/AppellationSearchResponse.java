...
public class AppellationSearchResponse extends GenericListResponse<Appellation> {
    private int page;
    private int size;
    private String query;
    public AppellationSearchResponse(List<Appellation> items, int count, int page, int size, String query) {
