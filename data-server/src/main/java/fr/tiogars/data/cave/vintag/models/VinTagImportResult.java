...
public class VinTagImportResult {

    @Schema(description = "Liste des tags de vin ajoutes pendant cet import.")
    private List<VinTag> imported;

    @Schema(description = "Nombre de tags de vin ajoutes (champ historique).", example = "12")
    private int importedCount;

    @Schema(description = "Liste des noms detectes en doublon (champ historique).")
    private List<String> duplicateNames;

    @Schema(description = "Nombre de tags de vin non ajoutes (champ historique).", example = "3")
    private int skippedCount;

    @Schema(description = "Nombre de tags de vin ajoutes.", example = "12")
    private int addedCount;

    @Schema(description = "Nombre total de tags de vin non ajoutes.", example = "3")
    private int notAddedCount;

    @Schema(description = "Nombre de tags de vin non ajoutes car deja presents.", example = "2")
    ...
    public VinTagImportResult(List<VinTag> imported, int addedCount, int notAddedCount, int alreadyExistsCount, int invalidCount, List<String> duplicateNames) {
    ...
    public List<VinTag> getImported() {
        return imported;
    }

    public void setImported(List<VinTag> imported) {
        this.imported = imported;
    }
