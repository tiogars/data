...
BEGIN
    IF EXISTS (
        ...
        ALTER TABLE section_document
            ...
            USING CASE
            WHEN id IS NULL OR id::text = '' THEN '00000000-0000-0000-0000-000000000001'
            ELSE id::text
        END;
    END IF;
END $$;;
...
SELECT '00000000-0000-0000-0000-000000000001', 'Document par défaut', 'default'
WHERE NOT EXISTS (SELECT 1 FROM section_document WHERE id = '00000000-0000-0000-0000-000000000001');;
...
BEGIN
    IF EXISTS (
        ...
        ALTER TABLE section
            ...
            USING CASE
                WHEN document_id IS NULL OR document_id::text = '' THEN '00000000-0000-0000-0000-000000000001'
                ELSE document_id::text
            END;
    END IF;

    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'section') THEN
        UPDATE section SET document_id = '00000000-0000-0000-0000-000000000001' WHERE document_id IS NULL;
    END IF;
END $$;;
