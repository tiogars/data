...
import { useGetContinentQuery } from '../../../services/continentApi';
import type { ContinentDetailPageProps } from './ContinentDetailPage.types';

export const ContinentDetailPage: FC<ContinentDetailPageProps> = ({ id }) => {
    ...
    <Paper variant="outlined" sx={{ p: { xs: 2.5, md: 3 }, maxWidth: 760, mx: 'auto', mt: 3 }}>
      <Stack spacing={2}>
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} sx={{ justifyContent: 'space-between', alignItems: { sm: 'center' } }}>
          ...
          <Button component={RouterLink} to={`/continent/${id}/edit`} variant="contained">
            Modifier
          </Button>
        </Stack>
        <Divider />
