...
import { type FooterLink, useDeleteFooterLinkByIdMutation, useListFooterLinksQuery } from '../../../services/footerLinkApi';
...
export const FooterLinkListPage: FC<FooterLinkListPageProps> = () => {
  ...
  const { data, isLoading, error, refetch } = useListFooterLinksQuery(undefined, { refetchOnMountOrArgChange: true });
