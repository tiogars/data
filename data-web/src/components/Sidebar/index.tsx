...
const canonicalMenuPathMap: Record<string, string> = {
  ...
  "/model": "/model/list",
  "/car": "/car/list",
  "/appellation": "/appellation/list",
  "/couleur": "/couleur/list",
  "/cepage": "/cepage/list",
  "/circonstance": "/circonstance/list",
  "/type-vin": "/type-vin/list",
  "/vin-tag": "/vin-tag/list",
  "/maison": "/maison/list",
  "/contenant": "/contenant/list",
  "/vin-nom": "/vin-nom/list",
  "/vin": "/vin/list",
